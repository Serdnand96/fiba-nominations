  ...
  return (
    <div ref={wrapperRef} className={`relative ${className}`}>
      ...
      <button
        ...
        className="w-full flex items-center justify-between px-3 py-2 border rounded-lg text-sm bg-white hover:bg-gray-50 text-left min-w-[260px]"
      >
              ...
              filtered.map(c => (
                <button
                  ...
                  className={`w-full text-left px-4 py-2.5 text-sm hover:bg-blue-50 flex items-center justify-between transition-colors ${
                    c.id === value ? 'bg-blue-50 text-blue-700' : 'text-gray-700'
                  }`}
                >
