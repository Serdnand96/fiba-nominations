const translations = {
  ...
  nav: {
    ...
    feed: { en: 'Wall', es: 'Muro' },
  },

  // ===== Muro (feed) =====
  feed: {
    title: { en: 'Wall', es: 'Muro' },
    subtitle: { en: "What's going on at FIBA Americas, day to day", es: 'Lo que pasa en FIBA Americas, día a día' },
    composerPlaceholder: { en: "What's up, {name}?", es: '¿Qué está pasando, {name}?' },
    publish: { en: 'Post', es: 'Publicar' },
    publishing: { en: 'Posting...', es: 'Publicando...' },
    ctrlEnter: { en: 'Ctrl + Enter to post', es: 'Ctrl + Enter para publicar' },
    addPhoto: { en: 'Photo', es: 'Foto' },
    addLink: { en: 'Link', es: 'Link' },
    addPoll: { en: 'Poll', es: 'Encuesta' },
    linkPlaceholder: { en: 'https://...', es: 'https://...' },
    invalidLink: { en: 'The link must start with http:// or https://', es: 'El link tiene que empezar con http:// o https://' },
    pollOption: { en: 'Option {n}', es: 'Opción {n}' },
    addOption: { en: '+ Add option', es: '+ Agregar opción' },
    pollNeedsTwo: { en: 'A poll needs at least two options', es: 'Una encuesta necesita al menos dos opciones' },
    official: { en: 'Official announcement', es: 'Aviso oficial' },
    officialHint: { en: 'Stands out with a badge. Moderators only.', es: 'Se destaca con una etiqueta. Solo moderadores.' },
    linkEvent: { en: 'Link to an event', es: 'Vincular a un evento' },
    noEvent: { en: 'No event', es: 'Sin evento' },
    imageTooLarge: { en: 'Image too large (max 5 MB)', es: 'Imagen muy pesada (máx. 5 MB)' },
    removeImage: { en: 'Remove image', es: 'Quitar imagen' },
    moderatorHint: { en: "You're a moderator: you can pin, mark as official and remove other people's posts.", es: 'Sos moderador: podés fijar, marcar como oficial y borrar publicaciones ajenas.' },

    // Categorías
    all: { en: 'Everything', es: 'Todo' },
    general: { en: 'General', es: 'General' },
    news: { en: 'Team news', es: 'Novedades' },
    event: { en: 'Events', es: 'Eventos' },
    hr: { en: 'HR', es: 'RRHH' },
    fun: { en: 'Off-topic', es: 'Para reírse' },
    kudos: { en: 'Kudos', es: 'Aplausos' },
    pinnedOnly: { en: 'Pinned', es: 'Fijados' },

    // Post
    pinned: { en: 'Pinned', es: 'Fijado' },
    officialBadge: { en: 'Official', es: 'Oficial' },
    edited: { en: 'edited', es: 'editado' },
    justNow: { en: 'just now', es: 'recién' },
    minutesAgo: { en: '{n} min ago', es: 'hace {n} min' },
    hoursAgo: { en: '{n} h ago', es: 'hace {n} h' },
    daysAgo: { en: '{n} d ago', es: 'hace {n} d' },
    pin: { en: 'Pin to top', es: 'Fijar arriba' },
    unpin: { en: 'Unpin', es: 'Desfijar' },
    markOfficial: { en: 'Mark as official', es: 'Marcar como oficial' },
    unmarkOfficial: { en: 'Remove official mark', es: 'Quitar marca oficial' },
    postActions: { en: 'Post actions', es: 'Acciones de la publicación' },
    confirmDeleteTitle: { en: 'Delete post?', es: '¿Eliminar publicación?' },
    confirmDeleteBody: { en: 'The post goes away with its reactions and comments. This cannot be undone.', es: 'Se borra la publicación con sus reacciones y comentarios. No se puede deshacer.' },
    confirmDeleteComment: { en: 'Delete this comment?', es: '¿Eliminar este comentario?' },
    deleted: { en: 'Post deleted', es: 'Publicación eliminada' },
    saved: { en: 'Saved', es: 'Guardado' },
    postFailed: { en: 'Could not publish', es: 'No se pudo publicar' },
    actionFailed: { en: 'Something went wrong', es: 'Algo salió mal' },
    react: { en: 'React with {emoji}', es: 'Reaccionar con {emoji}' },
    openLink: { en: 'Open link', es: 'Abrir link' },

    // Comentarios
    comments: { en: 'comments', es: 'comentarios' },
    comment: { en: 'comment', es: 'comentario' },
    noComments: { en: 'Be the first to comment', es: 'Sé el primero en comentar' },
    commentPlaceholder: { en: 'Write a comment...', es: 'Escribí un comentario...' },
    send: { en: 'Send', es: 'Enviar' },
    hideComments: { en: 'Hide comments', es: 'Ocultar comentarios' },

    // Encuesta
    votes: { en: '{n} votes', es: '{n} votos' },
    vote: { en: '1 vote', es: '1 voto' },
    yourVote: { en: 'Your vote', es: 'Tu voto' },
    voteHint: { en: 'Pick an option to vote', es: 'Elegí una opción para votar' },

    // Estados
    empty: { en: 'The wall is quiet', es: 'El muro está tranquilo' },
    emptyBody: { en: 'Nothing posted yet. Break the ice!', es: 'Todavía no hay publicaciones. ¡Rompé el hielo!' },
    emptyFiltered: { en: 'Nothing here', es: 'Nada por acá' },
    emptyFilteredBody: { en: 'No posts in this category yet.', es: 'Todavía no hay publicaciones en esta categoría.' },
    ...
    live: { en: 'Live', es: 'En cancha' },
    noEvents: { en: 'Nothing in the next 60 days', es: 'Nada en los próximos 60 días' },
    traveling: { en: 'On the road this week', es: 'De viaje esta semana' },
    noTraveling: { en: 'Everyone at home this week', es: 'Esta semana todos en casa' },
    weekTitle: { en: 'The wall this week', es: 'El muro esta semana' },
    weekPosts: { en: 'posts', es: 'publicaciones' },
    weekReactions: { en: 'reactions', es: 'reacciones' },
    weekComments: { en: 'comments', es: 'comentarios' },
    topAuthor: { en: 'Most active', es: 'Más activo' },
  },
  ...
  competitions: {
    ...
    noYear: { en: 'No year', es: 'Sin año' },
    dates: { en: 'Dates', es: 'Fechas' },
    allTemplates: { en: 'All templates', es: 'Todos los templates' },
    oneCompetition: { en: 'competition', es: 'competencia' },
    manyCompetitions: { en: 'competitions', es: 'competencias' },
    noResults: { en: 'No results', es: 'Sin resultados' },
    nominations: { en: 'Nominations', es: 'Nominaciones' },
    edit: { en: 'Edit', es: 'Editar' },
    delete: { en: 'Delete', es: 'Eliminar' },
  ...
  profile: {
    ...
    changePhoto: { en: 'Change photo', es: 'Cambiar foto' },
    removePhoto: { en: 'Remove picture', es: 'Quitar imagen' },
    ...
    uploaded: { en: 'Profile picture updated', es: 'Imagen de perfil actualizada' },
    removed: { en: 'Profile picture removed', es: 'Imagen de perfil quitada' },
    confirmRemove: { en: 'Remove your profile picture?', es: '¿Quitar tu imagen de perfil?' },
