const translations = {
  ...
  payments: {
    ...
    // Budget imputation (migration 038). The old `budget` selector fed
    // payment_budgets, which mixed department and budget line in one column.
    department: { en: 'Department', es: 'Departamento' },
    selectDepartment: { en: 'Select department...', es: 'Selecciona departamento...' },
    departmentRequired: { en: 'Please select a department', es: 'Selecciona un departamento' },
    allDepartments: { en: 'All departments', es: 'Todos los departamentos' },
    ...
    airfareHint: { en: 'Flight cost — tracked apart, not added to the payment total, but it does consume the travel budget line.', es: 'Costo del pasaje — se registra aparte y no suma al total del pago, pero sí consume la línea de viaje del presupuesto.' },
    total: { en: 'Total', es: 'Total' },
