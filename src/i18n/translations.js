const translations = {
  ...
  templates: {
    ...
    ph: {
      competition_name: { en: 'Competition name', es: 'Nombre de la competencia' },
      competition_year: { en: 'Competition year', es: 'Año de la competencia' },
      confirm_email: { en: 'Email to confirm to', es: 'Email al que confirmar' },
      confirm_line: { en: 'Full confirmation paragraph, with the deadline in red', es: 'Párrafo completo de confirmación, con la fecha límite en rojo' },
      deadline: { en: 'Confirmation deadline', es: 'Fecha límite de confirmación' },
      dear_line: { en: 'Greeting, with the nominee name in red', es: 'Saludo, con el nombre del nominado en rojo' },
      fee_lines: { en: 'Payment lines (fee, incidentals, total in bold)', es: 'Líneas de pago (fee, incidentals, total en negrita)' },
      game_dates: { en: 'Assigned game dates', es: 'Fechas de los juegos asignados' },
      host_line: { en: 'Host city and country', es: 'Ciudad y país sede' },
      letter_date: { en: 'Letter date', es: 'Fecha de la carta' },
      role_label: { en: 'Role in full (Technical Delegate / Video Graphic Operator)', es: 'Rol completo (Technical Delegate / Video Graphic Operator)' },
      ...
      banking_line: { en: 'Banking details paragraph', es: 'Párrafo sobre datos bancarios' },
      payment_intro: { en: 'Sentence introducing the payment details', es: 'Frase que introduce el detalle de pago' },
      bcla_date: { en: 'Letter date, in "Miami, January 15th, 2026" form', es: 'Fecha de la carta, formato "Miami, January 15th, 2026"' },
      bcla_title: { en: 'Letter heading', es: 'Título de la carta' },
      lsb_title: { en: 'Letter heading', es: 'Título de la carta' },
    },
  },
